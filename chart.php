        ...
        <div class="page-wrapper">
            ...
            <div class="select-item">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <select class="form-control input-default" id="link" class="link">
                            <option></option>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 id="count1">678</h2>
                                    <p class="m-b-0" id="date1">2018-08-08</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 id="count2">567</h2>
                                    <p class="m-b-0" id="date2">2018-5-03</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2 id="totalcount">totalcount</h2>
                                    <p class="m-b-0" id=>Total Customers</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="media">
                                ...
                                <div class="media-body media-text-right input-default">
                                    <h2 id="card-total">Card Transaction</h2>
                                    <p class="m-b-0">Card Transaction</p>
                                </div>
                        </div>
                    </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-university f-s-40 color-danger"></i></span>
                                </div>
                                <div class="media-body media-text-right input-default">
                                    <h2 id="net">Net Banking</h2>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 All rights reserved. Template designed by Malathi</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
